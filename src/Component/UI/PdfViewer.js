...
const Skills = (props) => (
    <View style={educationStyles.container}>
        <View style={{ backgroundColor: '#323131', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center', width: '100%' }}>
            <Title>Skills</Title>
        </View>
...
const Education = (props) => (
    <View style={educationStyles.container}>
        <View style={{ backgroundColor: '#323131', flexDirection: 'column', alignItems: 'flex-start', width: '100%' }}>
